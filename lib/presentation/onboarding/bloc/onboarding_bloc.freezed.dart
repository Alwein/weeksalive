...
mixin _$OnboardingState {
  OnboardingPageIndex get currentPage => throw _privateConstructorUsedError;
...
abstract class $OnboardingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({OnboardingPageIndex currentPage});
}
...
class _$OnboardingStateImpl implements _OnboardingState {
  const _$OnboardingStateImpl({this.currentPage = OnboardingPageIndex.first});

  @override
  @JsonKey()
  final OnboardingPageIndex currentPage;
...
abstract class _OnboardingState implements OnboardingState {
  const factory _OnboardingState({final OnboardingPageIndex currentPage}) =
      _$OnboardingStateImpl;

  @override
  OnboardingPageIndex get currentPage;

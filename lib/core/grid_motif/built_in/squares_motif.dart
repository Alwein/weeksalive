...
abstract final class SquaresMotif {
  static final _filled = [BuiltInCellDraws.filledSquare];
  static final _stroke = [BuiltInCellDraws.strokeSquare];

  static final definition = GridMotifDefinition(
    id: GridMotifId.squares,
    representations: {

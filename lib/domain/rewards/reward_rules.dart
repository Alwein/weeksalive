...
abstract final class RewardRules {
  static const List<RewardRule> all = [
    ...
    RewardRule(id: RewardId.appIconDraw, condition: StreakMilestoneCondition(0)),
    RewardRule(id: RewardId.appIconOutline, condition: StreakMilestoneCondition(0)),
    RewardRule(id: RewardId.appIconSisyphus, condition: StreakMilestoneCondition(0)),
    RewardRule(id: RewardId.appIconGold, condition: StreakMilestoneCondition(0)),
